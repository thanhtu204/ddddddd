 ...
 */
public abstract class NhanVien extends Ngay implements Comparable<NhanVien>{
    ...
    protected void xuat(){
        System.out.print("-MaNV: "+this.MaNV+"- Ho ten: "+this.hoTen);
        super.Xuat();
    }
    ...
    @Override
    public int compareTo(NhanVien hs){
